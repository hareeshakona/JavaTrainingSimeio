...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
		...
		List<Object> error = Arrays.asList("This method is not supported","Supported methods are"+ex.getSupportedHttpMethods());		
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex,
			HttpHeaders headers, HttpStatus status, WebRequest request) {
		String message = ex.getMessage();
		List<Object> error = Arrays.asList("This media type is not supported","Supported media types are"+ex.getSupportedMediaTypes());
	...
	public ResponseEntity<Object> handleBookNotFound(Exception ex) {
		String message = ex.getMessage();
		List<Object> error = Arrays.asList("book not found");
